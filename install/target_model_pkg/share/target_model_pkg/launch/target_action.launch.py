...
def generate_launch_description():
    ...
    declare_x = launch.actions.DeclareLaunchArgument('x', default_value='0.0')
    declare_y = launch.actions.DeclareLaunchArgument('y', default_value='1.0')
    declare_z = launch.actions.DeclareLaunchArgument('z', default_value='0.5')
